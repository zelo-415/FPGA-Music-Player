...
HD_PWD='E:/3200102346/lab19_MusicPlayer/vivado/Music_player/Music_player.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MusicPLayerTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MusicPLayerTop.tcl
