...
HD_PWD='E:/3200102346/lab19_MusicPlayer/vivado/Music_player/Music_player.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MusicPLayerTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MusicPLayerTop.tcl -notrace
